<div class="panel panel-margin-bottom recent-recipient-row">
  <div class="panel-body">
    ...
    <div class="container-fluid ps0 pb- border-bottom-small">
      <div class="row">
        <div class="col-xs-6">July 2016</div>
        <div class="col-xs-6 text-right">
          <a class="btn btn-subtle collapse-indicator collapsed" role="button" data-toggle="collapse" href="#details_1" aria-expanded="false" aria-controls="details_1">
            Details
          </a>
        </div>
      </div>
