<div id="signinModalRec" class="modal fade" tabindex="-1" role="dialog">
      ...
      <div class="modal-body">
        <div class="container-fluid" tabindex="-1" role="dialog">
          <div class="col-md-12 col-xs-12">
            <p class="text-center mb0"><strong>Welcome back, Hezekiah!</strong></p>
            <form>
            ...
            <p class="text-center mt mb0">Forgot your password? <a href="">Reset It</a></p>
