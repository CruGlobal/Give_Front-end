<div id="editBankAccountPaymentMethod" class="modal account-management" tabindex="-1" role="dialog">
                ...
                <div class="mb">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control  form-control-subtle" value="Chase">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Bank</label>
                        <input type="text" class="form-control  form-control-subtle" value="JP Morgan Chase & Co.">
                      </div>
                    </div>
                    <div class="col-sm-6">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control  form-control-subtle" value="*****1309">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Account Number</label>
                        <input type="text" class="form-control  form-control-subtle" value="**********0025">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Retype Account #</label>
                        <input type="email" class="form-control  form-control-subtle" value="**********0025">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      Locate your Routing and Account Numbers <a href="" class="circle-it bank-explain-trigger"><i
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="bank-explain-wrap">
                        <div class="panel panel-default panel-secondary">
                          <div class="panel-body">
                            <div class="row">
                              <div class="col-sm-8">
                                <img src="/assets/img/check-sample.png" alt="Credit Card Icon"/>
                              </div>
                              <div class="col-sm-4">
                                <h4>Where to find it.</h4>
                                <p>Use your account and routing numbers from your check. Don't use your deposit
                                  slip.</p>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="col-sm-12">
                      <div class="panel panel-default">
                        <div class="panel-body agreement-text p-">
                          <p>By selecting the "I Agree" checkbox below, I acknowledge that I have read, understand and
                            agree to these Terms and Conditions, and that this agreement constitutes a "writing signed
                            by me" under any applicable law or regulation. I authorize Cru to initiate electronic
                            funds transfers (debits) from my account at the financial institution listed above, and to
                            initiate</p>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="checkbox-inline agreement">
                          ...
                          <span>I hereby certify that I have read and understand the Terms and Conditions.</span>
                        </label>
                      </div>
