                                    ...
                                    <div class="mb0">
                                        <div class="row">
                                            <div class="col-md-12 text-right">
                                                ...
                                                <a class="btn btn-primary" data-toggle="modal" data-target="#editPaymentMethod" data-dismiss="modal">Confirm Delete</a>
                                            </div>
                                            <div class="col-md-12 text-right">
                                                <a class="" data-toggle="modal" data-target="#confirmDeletePaymentMethodTransfer" data-dismiss="modal">Alternate Delete Payment w/ Transfer</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
